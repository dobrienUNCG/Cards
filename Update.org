...
*** TODO Reading 
**** TODO Improve method of reading data from files
**** TODO Finalize structure for save file (reading purposes)
*** TODO Writing
...
*** Connect Views
*** Add Controllers
    These should be seperate from the views themselves. I don't think
    we should have the same class that creates the view being the same
    one that acts as the controller.
